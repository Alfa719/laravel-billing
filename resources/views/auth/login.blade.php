                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" id="input-email" placeholder="name@example.com" name="email" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="password" id="input-password" placeholder="Password" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-block btn-primary">Sign in</button>
                                </form>
                                <div class="py-3 text-center">
                                    <span class="text-sm text-capitalize">New Member ? <a href="{{ route('register') }}">Register Here!</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
